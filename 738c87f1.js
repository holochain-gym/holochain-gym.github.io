import"./099c0a8b.js";import{h as e}from"./178f3cd5.js";import{H as t,E as n,a as o,Z as s,C as i}from"./44f92166.js";import"./962426a7.js";let a,l,r=e=>e;customElements.define("holochain-playground-container",t),customElements.define("entry-graph",n),customElements.define("entry-contents",o),customElements.define("zome-fns-results",s),customElements.define("call-zome-fns",i);const c={name:"simulated-app",description:"",slots:{default:{dna:{zomes:[{name:"helloworld",entry_defs:[{id:"greeting",visibility:"Public"}],validation_functions:{},zome_functions:{say_greeting:{call:({create_entry:e})=>({content:t})=>e({content:t,entry_def_id:"greeting"}),arguments:[{name:"content",type:"String"}]}}}]},deferred:!1}}},d=()=>e(a||(a=r`
  ...
  `),1,m,(e=>{const t=e.detail.conductors[0].getAllCells()[0].cellId;e.target.activeAgentPubKey=t[1]}),["Agent"]),g=document,p=[{key:"Simple",story:d},{key:"Exercise",story:y}];let f=!1;for(const e of p){const t=g.querySelector(`[mdjs-story-name="${e.key}"]`);t&&(t.story=e.story,t.key=e.key,f=!0,Object.assign(t,{}))}f&&(customElements.get("mdjs-preview")||import("./075807ca.js"),customElements.get("mdjs-story")||import("./5f14f766.js"));export{y as Exercise,d as Simple};
