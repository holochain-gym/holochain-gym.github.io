...
The Holochain team built a Rust library `hdk3`, which stands for *holochain development kit* and contains all important Holochain functions you will want to call from within your zome. So add this line to the top your file.
